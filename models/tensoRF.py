...
class TensorCP(TensorBase):
    ...
    def compute_densityfeature(self, xyz_sampled):
        ...
        a = self.density_line[0]
        b = coordinate_line[[0]]

        line_coef_point = F.grid_sample(a, b, align_corners=True).view(-1,
                                                                       *xyz_sampled.shape[
                                                                        :1])
...
class SDFTensorCP(TensorBase):
    ...
    def compute_densityfeature(self, xyz_sampled):
        ...
        line_coef_point = F.grid_sample(a, b, align_corners=True).view(-1, *xyz_sampled.shape[:1])
