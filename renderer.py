...
def SDFRenderer(positions, tensorf, chunk=4096, is_train=True, device='cuda'):
    # Debug needed
...
def evaluation(test_dataset, tensorf, args, renderer, savePath=None, N_vis=5, prtx='', N_samples=-1,
    ...
    idxs = list(range(0, test_dataset.all_pos.shape[0], img_eval_interval))
    for i in range(0, len(test_dataset.all_pos), batch_size):
        samples = test_dataset.all_pos[i:i + batch_size]
